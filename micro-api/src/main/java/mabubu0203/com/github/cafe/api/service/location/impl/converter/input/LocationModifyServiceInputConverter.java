...
public class LocationModifyServiceInputConverter
    implements ServiceInputConverter<LocationModifyServiceInput, LocationEntity> {

  @Override
  public LocationEntity apply(LocationModifyServiceInput input) {
